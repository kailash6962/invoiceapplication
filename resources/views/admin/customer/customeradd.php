  ...
  <div class="card ">
    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <form method="POST" id="customeradd-form" autocomplete="off">
              <!-- Grid column -->
              <div class="col-md-12 mb-4">

          <div class="md-form md-outline">
            <input type="text" id="f2" class="form-control" name="cust_code" id="cust_code" value="<?=generatecust_code()?>" readonly>
